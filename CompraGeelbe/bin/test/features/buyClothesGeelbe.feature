...
Feature: Buy clothes in Geelbe.com
  ...
  Scenario Outline: Buy in Geelbe.com
    ...
    Then he should see the product <name> in the shopping car and the correct price of <quantity> total
    ...
    Examples: 
      ...
      | Hombre 		| Relojes			| Apa-Ba Negro - Reebok			| S--A		| 2 			 |Cra 29B No 70-35	| Antioquia		|Medellin	|3002211000	|1026333101			| 20			| David	Noriega	|	10892325435		| MASTERCARD	|5								|	2019						|	9876					|5			|				
